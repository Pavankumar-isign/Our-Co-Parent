...
export default function EventList({ events, onEventClick, currentUserId }: EventListProps) {
        ...
        <div className="space-y-4">
            {events.map(event => (
                <div
                    ...
                    className="group bg-white rounded-xl border border-gray-100 p-4 hover:border-indigo-100 hover:shadow-md transition-all cursor-pointer"
                >
  ...
  >
    Request Time Swap
                        ...
                        <div className="w-3 h-3 rounded-full mt-1.5" style={{ backgroundColor: event.color }} />
                    </div>
                </div>
            ))}
        </div>
