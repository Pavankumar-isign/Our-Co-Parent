...
// export default function CalendarHeader({ calendarRef }: { calendarRef: React.RefObject<FullCalendar> }) {
//   const { view, date, setView, openEventModal } = useCalendarStore();
//   const [showFilters, setShowFilters] = useState(false);
...
//           <ChevronRight size={20} />
//         </button>
//         <button onClick={handleToday} className="px-3 py-1 text-sm bg-blue-50 text-blue-600 hover:bg-blue-100 rounded-md">
//           Today
//         </button>
//       </div>
